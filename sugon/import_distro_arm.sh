...
ImportDistroAarch64 "uos_0307_desktop" "${MIX_NAME}" "vmlinuz" "initrd.img"
...
ImportDistroAarch64 "uos_sp1_desktop" "${MIX_NAME}" "vmlinuz" "initrd.img"
...
ImportDistroAarch64 "uos_sp1_server_test" "${MIX_NAME}" "vmlinuz" "initrd.img"
...
ImportDistroAarch64 "uos_sp1_server" "${MIX_NAME}" "vmlinuz" "initrd.img"
...
ImportDistroAarch64 "Phytium_UOS_V20_SP2U1_Desktop" "${MIX_NAME}" "vmlinuz" "initrd.img"
...
ImportDistroAarch64 "kylin_sp4_J1/casper" "${MIX_NAME}" "uImage" "initrd.img"
...
ImportDistroAarch64 "kos_0429_desktop" "${MIX_NAME}" "Image" "initrd.img"
...
ImportDistroAarch64 "kylin_desktop_sp4_0530_Z1" "${MIX_NAME}" "Image" "initrd.img"
...
ImportDistroAarch64 "Phytium_Kylin_V10_0710_Desktop" "${MIX_NAME}" "Image" "initrd.img"
...
ImportDistroAarch64 "TJNKQZF_Phytium_Kylin_V10_0710_Desktop" "${MIX_NAME}" "Image" "initrd.img"
...
ImportDistroAarch64 "TJDLQZF_Phytium_Kylin_V10_0710_Desktop" "${MIX_NAME}" "Image" "initrd.img"
...
ImportDistroAarch64 "XHB2003580_HSBMJYJ_Phytium_UOS_V20_SP2U1_Desktop" "${MIX_NAME}" "vmlinuz" "initrd.img"
...
ImportDistroAarch64 "XHB2003490_Phytium_UOS_V20_SP2U1_0910_Desktop" "${MIX_NAME}" "vmlinuz" "initrd.img"
...
ImportDistroAarch64 "XAH2002860_Phytium_UOS_V20_SP2U1_Desktop" "${MIX_NAME}" "vmlinuz" "initrd.img"
...
ImportDistroAarch64 "XAH2002860_Phytium_UOS_V20_SP2U1_0926_Desktop" "${MIX_NAME}" "vmlinuz" "initrd.img"
...
ImportDistroAarch64 "XCQ2001000_Phytium_UOS_V20_SP2U1_Desktop" "${MIX_NAME}" "vmlinuz" "initrd.img"
...
ImportDistroAarch64 "XHB2004010_Phytium_UOS_V20_SP2U1_Desktop" "${MIX_NAME}" "vmlinuz" "initrd.img"
...
ImportDistroAarch64 "XHB200488_Phytium_UOS_V20_SP2U2_Desktop" "${MIX_NAME}" "vmlinuz" "initrd.img"
