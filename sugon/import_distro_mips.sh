...
ImportProfile "${MIX_NAME}" "${MIX_NAME}" "boot=casper quiet splash only-ubiquity loglevel=0 audit=0 netboot=nfs nfsroot=${PXE_AD}:/install/lx/BM_loongson_kylin_v10_0907_desktop_240G_jc/ 3"
