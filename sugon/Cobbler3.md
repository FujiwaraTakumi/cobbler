...
> cobbler distro add --name=CentOS8U2-Manual --kernel=/mnt/images/pxeboot/vmlinuz --initrd=/mnt/images/pxeboot/initrd.img

添加profile：

> cobbler profile add --name=CentOS8U2-Manual --distro=CentOS8U2-Manual --kernel-options="XXX"
...
# openssl passwd -1 -salt `openssl rand 15 -base64` '111111'
default_password_crypted: "$1$W0FDFR28$eZe/BTyKb/mbhO1SWwgJ9."
